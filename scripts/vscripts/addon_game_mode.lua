...
function Precache( context )
	...
	print("[NECROMASTERTEST] Performing pre-load precache")
...
LOG_FILE = "log/necromastertest.txt"

InitLogFile(LOG_FILE, "[[ necromastertest ]]")
...
function Activate()
	GameRules.necromastertest = necromastertest()
	GameRules.necromastertest:Initnecromastertest()
end
